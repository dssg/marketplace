...
urlpatterns = [
    ...
    path('org/<int:org_pk>/staff/request/<int:request_pk>/', org.OrganizationMembershipRequestView.as_view(), name='org_staff_request_detail'),
    path('org/<int:org_pk>/staff/request/<int:request_pk>/review', org.process_organization_membership_request_view, name='org_staff_request_review'),
    ...
    path('proj/<int:proj_pk>/task/<int:task_pk>/review/<int:review_pk>/', proj.ProjectTaskReviewView.as_view(), name='proj_task_review_detail'),
    path('proj/<int:proj_pk>/task/<int:task_pk>/review/<int:review_pk>/resolve', proj.process_task_review_request_view, name='proj_task_review'),
