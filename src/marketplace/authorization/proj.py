...
add_perm('project.approve_as_completed', ProjectService.user_can_complete_project)
...
add_perm('project.task_review_do', ProjectService.user_can_review_project_tasks)
add_perm('project.tasks_view', ProjectService.user_can_view_project_tasks)
