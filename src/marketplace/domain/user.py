...
def _process_social_login_user(request, sociallogin, **_kwargs):
    ...
    populates a new User instance -- and without the involvement of this
    codebase. To avoid needless overriding of allauth methods, the
    allauth-constructed User is processed here, before it is later
